...
async function main() {
    try {
        ...
        const contract = network.getContract('hrecords');
        ...
        /*let records = {
            ...
            refIFPS:'1001',
            owner:'erikson',
            documentType:'Labs Records',
            timestamp:Date.now().toString()
        }*/
        let result = await contract.submitTransaction('createHealthcareLabs','1002','1002','1001','erikson','Labs records',Date.now().toString());
