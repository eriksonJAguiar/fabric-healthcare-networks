...
function printHelp () {
  ...
  echo "        byfn.sh up -c healthchannel -s couchdb -i 1.1.0-alpha"
...
function upgradeNetwork () {
  ...
  for PEER in peer0.hprovider.healthcare.com peer1.hprovider.healthcare.com peer0.research.healthcare.com peer1.research.healthcare.com; do
...
# block - ``HealthOrdererGenesis`` - and one for our channel - ``HealthChannel``.
