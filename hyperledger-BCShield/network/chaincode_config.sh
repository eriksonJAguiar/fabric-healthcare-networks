...
peer chaincode install -n Healthcare-records -v 1.0 -l golang -p github.com/chaincode/Healthcare-records
...
peer chaincode instantiate -o ordererhp.healthcare.com:7050 -C healthchannel -l golang -n Healthcare-records -v 1.0 -c '{"Args":[]}'
...
peer chaincode invoke -n Healthcare-records -c '{"Args":["123", "222", "Running", "100", "-1828192 121212"], "Function":"initRecord"}' -C healthchannel

peer chaincode query -n Healthcare-records -c '{"Args":["123"], "Function":"readRecord"}' -C healthchannel
